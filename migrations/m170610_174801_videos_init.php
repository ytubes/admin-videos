...
class m170610_174801_videos_init extends Migration
{
    public function safeUp()
    {
        ...
        if ($tableSchema === null) {
			...
			/*
			ALTER TABLE `videos_images`
			  ADD CONSTRAINT `videos_images_ibfk_1` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`) ON UPDATE CASCADE;
			*/
        }
        ...
        if ($tableSchema === null) {
			...
			/*
			ALTER TABLE `videos_related_map`
			  ADD CONSTRAINT `videos_related_map_ibfk_1` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`) ON DELETE CASCADE ON UPDATE CASCADE,
			  ADD CONSTRAINT `videos_related_map_ibfk_2` FOREIGN KEY (`related_id`) REFERENCES `videos` (`video_id`) ON DELETE CASCADE ON UPDATE CASCADE;
			*/
        }
        ...
        if ($tableSchema === null) {
			...
			/*
			ALTER TABLE `videos_stats`
			  ADD CONSTRAINT `videos_stats_ibfk_1` FOREIGN KEY (`category_id`) REFERENCES `videos_categories` (`category_id`) ON DELETE CASCADE ON UPDATE CASCADE,
			  ADD CONSTRAINT `videos_stats_ibfk_2` FOREIGN KEY (`video_id`) REFERENCES `videos` (`video_id`) ON DELETE CASCADE ON UPDATE CASCADE,
			  ADD CONSTRAINT `videos_stats_ibfk_3` FOREIGN KEY (`image_id`) REFERENCES `videos_images` (`image_id`) ON DELETE CASCADE ON UPDATE CASCADE;
			*/
		}
        ...
        if ($tableSchema !== null) {
			...
			/*INSERT INTO `settings` (`module`, `name`, `value`) VALUES
			('videos', 'items_per_page', '30'),
			('videos', 'pagination_buttons_count', '5'),
			('videos', 'recalculate_ctr_period', '2000'),
			('videos', 'related_number', '15'),
			('videos', 'test_items_percent', '15'),
			('videos', 'test_items_start', '3'),
			('videos', 'test_item_period', '200');*/
		}
        ...
        if ($tableSchema !== null) {
        	$this->batchInsert($tableName, ['module', 'handler_class', 'cron_expression', 'priority', 'enabled'], [
        		['videos', '\ytubes\admin\videos\workers\RecalculateCTR', '* * * * *', 0, 1],
        		['videos', '\ytubes\admin\videos\workers\SwitchTestImage', '* * * * *', 1, 1],
        		['videos', '\ytubes\admin\videos\workers\ShiftCheckpoint', '* * * * *', 2, 1],
    ...
    {
        echo "m170610_174801_init cannot be reverted.\n";
