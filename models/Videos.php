 ...
 * @property VideosCategories[] $categories
 * @property VideosImages[] $videosImages
...
class Videos extends \yii\db\ActiveRecord
{
    ...
    {
        return $this->hasMany(VideosImages::className(), ['video_id' => 'video_id']);
    }
    ...
    {
        return $this->hasMany(VideosStats::className(), ['video_id' => 'video_id']);
    }
}
