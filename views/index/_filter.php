		...
		<div class="row show-grid">
			<div class="col-md-2">
				<div class="form-group">
					...
					<?= Html::activeDropDownList($model, 'user_id', ['' => 'Любой'] + User::listUser(), ['class' => 'form-control']) ?>
				</div>
			</div>
			...
			<div class="col-md-2">
				<div class="form-group">
					...
					<?= Html::activeDropDownList($model, 'status', ['' => 'Любой'] + VideoStatus::listStatus(), ['class' => 'form-control']) ?>
				</div>
			</div>
