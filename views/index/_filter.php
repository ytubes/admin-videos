...
if (!empty($model->videos_ids)) {
    $model->videos_ids = implode(',', $model->videos_ids);
}
        ...
        <div class="row show-grid">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?= Html::activeInput('text', $model, 'videos_ids', ['class' => 'form-control']) ?>
                </div>
            </div>
        </div>
        ...
        <div class="row show-grid">
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?= Html::activeDropDownList($model, 'user_id', User::listUser(), ['class' => 'form-control', 'prompt' => '-- Любой --']) ?>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?= Html::activeDropDownList($model, 'status', VideoStatus::listStatus(), ['class' => 'form-control', 'prompt' => '-- Любой --']) ?>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?= Html::activeDropDownList($model, 'category_id', CategoryFinder::getDropDownList(), ['class' => 'form-control', 'prompt' => '-- Все --']) ?>
                </div>
            </div>
            ...
            <div class="col-md-2">
                <div class="form-group">
                    ...
                    <?= Html::activeInput('text', $model, 'per_page', ['class' => 'form-control']) ?>
                </div>
            </div>
        </div>
